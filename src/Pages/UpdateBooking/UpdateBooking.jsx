...
const UpdateBooking = () => {
    ...
    const url = `http://localhost:5000/bookings?email=${user?.email}/${_id}`
    useEffect(() => {
        fetch(url)
            .then(res => res.json())
    ...
    return (
        <div>
            ...
            <div className="bg-[#F3F3F3] my-20 rounded-lg">
                <form className="py-20 " onSubmit={handleUpdateBooking}>
                    <div className="w-[1000px] mx-auto space-y-4">
                        <div className=" flex justify-center items-center w-full gap-4 ">
                            ...
                            <input type="date" name="date" defaultValue ={date} className="w-1/2 input input-bordered" />
