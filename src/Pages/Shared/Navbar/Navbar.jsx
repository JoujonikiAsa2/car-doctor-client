...
const Navbar = () => {
    ...
    const navLinks = <>
        ...
        <li className="lg:hidden md:hidden block"> <a>Appoinment</a></li>
        
        {
            user ? <>
            <li><Link to='/bookings'><button>My Bookings</button></Link></li>
                <li><button onClick={handleLogOut} className="btn btn-sm btn-warning text-xs capitalize">Log Out</button></li>
            </>
                :

                <li><Link to='/login' className="btn btn-sm btn-secondary text-xs capitalize">Login</Link></li>}
        ...
        <div>
            <div className="navbar bg-base-100 h-28 mb-4">
                <div className="navbar-start">
                    ...
                    <Link to='/' className="btn btn-ghost normal-case"><img src={logo} alt="" className="lg:w-24 md:w-20 w-12 h-8 md:h-12 lg:h-16" /></Link>
                </div>
                ...
                <div className="navbar-end flex gap-0">
                    ...
                    <a className="btn btn-sm text-xs capitalize lg:flex md:flex hidden">Appoinment</a>
                </div>
